...
headerLastPar :
    ...
    'Συνήλθε' COMMA? SPACE'ως Συμβούλιο' |
    'ΣΥΝΕΔΡΙΑΣΕ' COMMA? SPACE 'δημόσια' |
    'Συνεδρίασε Δημόσια') (.*?) NEXT_LINE (SPACE* NEXT_LINE+)?  ;
headerLastPar_alt:
    ('Των αναιρεσειόντων' |
...
DIASKEPSI :
    ...
    'Kρίθηκε' COMMA SPACE 'αποφασίστηκε' |
    'ΚΡΙΘΗΚΕ' COMMA SPACE? 'αποφασίσθηκε' |
    'ΚΡΙΘΗΚΕ' SPACE 'και' SPACE 'αποφασίσθηκε' |
    'ΚΡΙΘΗΚΕ και αποφασίστηκε' |
    'ΚΡΙΘΗΚΕ και ΑΠΟΦΑΣΙΣΘΗΚΕ' |
    'Kρίθηκε και αποφασίστηκε' |
