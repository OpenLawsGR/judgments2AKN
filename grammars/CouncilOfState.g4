...
motivPar : (MOTIVATION_PAR | THINK_BY_LAW ) DOT? NEXT_LINE+ (SPACE* NEXT_LINE+)? | MOTIVATION_PAR SPACE THINK_BY_LAW DOT? NEXT_LINE;
blockList : ste_item+;
...
decisionPar : (.*?) NEXT_LINE+ (SPACE* NEXT_LINE+)? | (.*?) DOT;
outcome : OUTCOME;
